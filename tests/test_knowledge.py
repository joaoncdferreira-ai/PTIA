...
class KnowledgeTests(unittest.TestCase):
    ...
    def test_builds_all_pages_and_versioned_payload(self):
        ...
        self.assertIn("Empresas de IA em Portugal · #1", resources)
        self.assertIn("Pessoas da IA em Portugal · #1", resources)
        self.assertIn("Ferramentas de IA · #1", resources)
        self.assertIn("Prompts PTIA · #1 da semana", resources)
