...
# Plano de agendamento cronológico para amanhã (7 de Junho de 2026)
PLAN = [
    ("topic_5dd5877f89e8ae4a81", "2026-06-07T09:00:00+01:00"),  # Espanha avança na corrida à IA
    ("topic_866460195a3bac2212", "2026-06-07T13:00:00+01:00"),  # Disparidade de Género na Adoção de IA (Anthropic)
    ("topic_1a1c15db417c871cb4", "2026-06-07T16:00:00+01:00"),  # Amazon investe 10 mil milhões na Europa
    ("topic_6e0deb1e52630a36e9", "2026-06-07T21:00:00+01:00"),  # Lisboa no Top 10 Europeu de Startups
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-07) ===")
    ...
    if instagram_posts_sorted:
        ...
        carousel_time = "2026-06-07T21:00:00+01:00"
            ...
            try:
                ...
                for p in instagram_posts_sorted:
                    ...
                    update_final_post_copy(
                        state.final_posts_path,
                        post_id=p.post_id,
                        notes="[2026-06-07] Agendado como parte do Carrossel Combinado de slides das 21:00."
                    )
                    scheduled_summary.append({
                        "post_id": p.post_id,
                        "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-07) ===")
