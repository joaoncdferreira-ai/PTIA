...
# Plano de agendamento cronológico para amanhã (23 de Junho de 2026)
PLAN = [
    ("topic_e38978ba1e7785d8a7", "2026-06-23T09:00:00+01:00"),  # Portugal MareNostrum 5
    ("topic_369cfe1ffa79d362eb", "2026-06-23T13:00:00+01:00"),  # SpaceX / Reflection AI
    ("topic_be5f40bec1eb209fd5", "2026-06-23T16:00:00+01:00"),  # Robotáxis na China
    ("topic_c6cc739f4015d5d72c", "2026-06-23T21:00:00+01:00"),  # John Jumper / Anthropic
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-23) ===")
    ...
    original_plan_order = [
        "topic_e38978ba1e7785d8a7",  # Portugal MareNostrum 5
        "topic_369cfe1ffa79d362eb",  # SpaceX / Reflection AI
        "topic_be5f40bec1eb209fd5",  # Robotáxis na China
        "topic_c6cc739f4015d5d72c",  # John Jumper / Anthropic
    ]
    ...
    if len(instagram_posts_sorted) == 4:
        ...
        combined_body = "\n\n".join(paragraphs)
        combined_hashtags = "#InteligenciaArtificial #IA #MareNostrum5 #Supercomputador #Portugal #SpaceX #ReflectionAI #OpenSource #Robotaxis #China #TechCrunch #JohnJumper #GoogleDeepMind #Anthropic #Nobel #PTIA #Negocios #Tech"
        ...
        carousel_time = "2026-06-23T21:00:00+01:00"
                    ...
                    for attempt in range(5):
                        try:
                            ...
                            update_final_post_copy(
                                state.final_posts_path,
                                post_id=p.post_id,
                                notes="[2026-06-23] Agendado no Instagram às 21:00."
                            )
                            break
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-23) ===")
