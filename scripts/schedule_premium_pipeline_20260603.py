...
# Plano de agendamento cronológico para amanhã (3 de Junho de 2026)
PLAN = [
    ("topic_ba03af79cbd56dce44", "2026-06-03T09:00:00+01:00"),  # NVIDIA e Microsoft RTX Spark
    ("topic_4e3ea51dab499095a1", "2026-06-03T13:00:00+01:00"),  # Bain & Company Produtividade
    ("topic_7f10658572bf7a24e5", "2026-06-03T16:00:00+01:00"),  # OpenAI Youth Safety
    ("topic_8e5cbd6bc6c4b5ccaf", "2026-06-03T21:00:00+01:00"),  # OIT Social Stability
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-03) ===")
    ...
    carousel_time = "2026-06-03T21:00:00+01:00"
    ...
    if first_inst.status == "scheduled" and first_inst.buffer_post_id and first_inst.buffer_post_id != "manual_buffer_media_required":
        ...
        for p in instagram_posts_sorted:
            ...
            update_final_post_copy(
                state.final_posts_path,
                post_id=p.post_id,
                notes="[2026-06-03] Agendado como parte do Carrossel Combinado de 4 slides das 21:00."
            )
            scheduled_summary.append({
                "post_id": p.post_id,
                "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-03) ===")
