...
def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-13) ===")
    ...
    if instagram_posts_sorted:
        ...
        carousel_time = "2026-06-13T21:00:00+01:00"
            ...
            try:
                ...
                for p in instagram_posts_sorted:
                    ...
                    update_final_post_copy(
                        state.final_posts_path,
                        post_id=p.post_id,
                        notes="[2026-06-13] Agendado no Instagram às 21:00."
                    )
                    scheduled_summary.append({
                        "post_id": p.post_id,
                        "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-13) ===")
