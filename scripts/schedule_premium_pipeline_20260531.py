...
X_POLISHED_BODIES = {
    "post_5be71030bab6b1f712": "A SAP Portugal aposta na cloud soberana para dar relevância europeia ao país na IA. A infraestrutura reduz barreiras de conformidade, mas resta saber se as nossas empresas vão saber usá-la.",
    "post_80d1c953073a3550fb": "A IA está a redefinir funções ao automatizar tarefas repetitivas, em vez de eliminar cargos. O foco imediato das empresas nacionais deve ser adaptar processos para ganhar eficiência real sem histeria.",
    "post_f77e4739d44bbd2fbf": "O CEO da Caixa Mágica aponta um novo paradigma: a regulação da IA é um componente de produto, não um entrave. Portugal deve usar a conformidade e a cibersegurança como fatores de diferenciação.",
    "post_2330996f32d0e7bb25": "O Papa alertou para os perigos da IA, coincidindo com uma parceria ética entre o Vaticano e a Anthropic. O objetivo é colocar a dignidade humana no centro da corrida de modelos."
}

# Plano de agendamento cronológico para amanhã (31 de Maio de 2026)
PLAN = [
    ("topic_386fdfa417cef2dde3", "2026-05-31T09:00:00+01:00"),  # SAP Portugal
    ("topic_a68ddc04b990431747", "2026-05-31T13:00:00+01:00"),  # IA e Emprego
    ("topic_c7bf6da32e7cf83ddf", "2026-05-31T16:00:00+01:00"),  # Identidade Digital
    ("topic_5c931bfe50c57f19c3", "2026-05-31T21:00:00+01:00"),  # Anthropic e Vaticano
]
...
def apply_x_polish_replacements(posts_path: Path) -> None:
    ...
    # Grava no ficheiro de forma segura
    posts_path.write_text("\n".join(lines) + "\n", encoding="utf-8")
    print(f"-> {modified_count} posts do X otimizados e gravados com sucesso!")

def main() -> None:
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-05-31) ===")
    ...
    carousel_time = "2026-05-31T21:00:00+01:00"
    ...
    for p in instagram_posts_sorted:
        ...
        update_final_post_copy(
            state.final_posts_path,
            post_id=p.post_id,
            notes="[2026-05-31] Agendado como parte do Carrossel Combinado de 4 slides das 21:00."
        )
        scheduled_summary.append({
            "post_id": p.post_id,
            "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-05-31) ===")
