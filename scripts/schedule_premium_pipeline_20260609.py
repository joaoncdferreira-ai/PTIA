...
# Plano de agendamento cronológico para amanhã (9 de Junho de 2026)
PLAN = [
    ("topic_bea871e53735138a7c", "2026-06-09T09:00:00+01:00"),  # Portugal e a IA: Proteger o Trabalho
    ("topic_9f608c63c7c00e7174", "2026-06-09T13:00:00+01:00"),  # OpenAI quer transformar ChatGPT em 'superapp'
    ("topic_847f4f1387a2651eee", "2026-06-09T16:00:00+01:00"),  # Nvidia adquire startup Kumo
    ("topic_5324eae70c3277eb71", "2026-06-09T21:00:00+01:00"),  # Microsoft Scout
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-09) ===")
    ...
    if instagram_posts_sorted:
        ...
        carousel_time = "2026-06-09T21:00:00+01:00"
            ...
            try:
                ...
                for p in instagram_posts_sorted:
                    ...
                    update_final_post_copy(
                        state.final_posts_path,
                        post_id=p.post_id,
                        notes="[2026-06-09] Agendado como parte do Carrossel Combinado de slides das 21:00."
                    )
                    scheduled_summary.append({
                        "post_id": p.post_id,
                        "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-09) ===")
