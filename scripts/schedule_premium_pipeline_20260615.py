...
# Plano de agendamento cronológico para hoje (15 de Junho de 2026)
PLAN = [
    ("topic_1ab3dae66e6a9c88ec", "2026-06-15T10:00:00+01:00"),  # Visa e OpenAI
    ("topic_b35c96b074a01d441f", "2026-06-15T13:00:00+01:00"),  # Seguro - IA na Justiça
    ("topic_4b3b62db06f6eec116", "2026-06-15T16:00:00+01:00"),  # DeepMind - Interação de Agentes
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-15) ===")
    ...
    print("\n-> [INFO] Agendamento de Instagram Carrossel omitido hoje. Será processado mais tarde com o post das 21:00.")
