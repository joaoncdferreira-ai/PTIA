...
# Plano de agendamento cronológico para amanhã (14 de Junho de 2026)
PLAN = [
    ("topic_4cf3d6ee9e2e4f597d", "2026-06-14T09:00:00+01:00"),  # Regulação em Portugal / Marcelo Rebelo de Sousa
    ("topic_43537910f9b49a901d", "2026-06-14T13:00:00+01:00"),  # Apple Intelligence e Siri
    ("topic_fb162ce86f056e4abc", "2026-06-14T16:00:00+01:00"),  # Casa Branca - Inovação e Segurança
    ("topic_adf725c6d67bd41a55", "2026-06-14T21:00:00+01:00"),  # Samsung - Integração de IA Generativa
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-14) ===")
    ...
    original_plan_order = [
        "topic_4cf3d6ee9e2e4f597d",  # Regulação em Portugal / Marcelo Rebelo de Sousa
        "topic_43537910f9b49a901d",  # Apple Intelligence e Siri
        "topic_fb162ce86f056e4abc",  # Casa Branca - Inovação e Segurança
        "topic_adf725c6d67bd41a55",  # Samsung - Integração de IA Generativa
    ]
    ...
    if instagram_posts_sorted:
        ...
        combined_body = "\n\n".join(paragraphs)
        combined_hashtags = "#InteligenciaArtificial #IA #Marcelo #Apple #Samsung #Ciberseguranca #PTIA #Negocios #Tech #Portugal #CasaBranca #Inovacao"
        ...
        carousel_time = "2026-06-14T21:00:00+01:00"
            ...
            try:
                ...
                for p in instagram_posts_sorted:
                    ...
                    update_final_post_copy(
                        state.final_posts_path,
                        post_id=p.post_id,
                        notes="[2026-06-14] Agendado no Instagram às 21:00."
                    )
                    scheduled_summary.append({
                        "post_id": p.post_id,
                        "channel": "instagram",
        ...
        print("-> Nenhum post de Instagram encontrado. A saltar.")
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-14) ===")
