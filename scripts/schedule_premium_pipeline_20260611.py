...
# Plano de agendamento cronológico para amanhã (11 de Junho de 2026)
PLAN = [
    ("topic_8c3e0909bc914098ca", "2026-06-11T09:00:00+01:00"),  # Igreja Católica e Inteligência Artificial...
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-11) ===")
    ...
    if instagram_posts_sorted:
        ...
        combined_body = "\n\n".join(paragraphs)
        combined_hashtags = "#InteligenciaArtificial #IA #Igreja #Episcopado #Portugal #PTIA"
        ...
        carousel_time = "2026-06-11T21:00:00+01:00"
            ...
            try:
                ...
                for p in instagram_posts_sorted:
                    ...
                    update_final_post_copy(
                        state.final_posts_path,
                        post_id=p.post_id,
                        notes="[2026-06-11] Agendado no Instagram às 21:00."
                    )
                    scheduled_summary.append({
                        "post_id": p.post_id,
                        "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-11) ===")
