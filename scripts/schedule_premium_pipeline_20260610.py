...
# Plano de agendamento cronológico para hoje (10 de Junho de 2026)
PLAN = [
    ("topic_9c9a63c2c44df11dc6", "2026-06-10T09:00:00+01:00"),  # Claude Fable 5: A nova aposta da Anthropic...
    ("topic_84c837ac4930992e12", "2026-06-10T13:00:00+01:00"),  # Inteligência Artificial na Contabilidade...
    ("topic_d0d01b1d0755c68998", "2026-06-10T16:00:00+01:00"),  # Nações Unidas alertam: fosso digital na IA...
    ("topic_89a3bf38de1eec038e", "2026-06-10T21:00:00+01:00"),  # Copa do Mundo 2026: IA na Tática...
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-10) ===")
    ...
    if instagram_posts_sorted:
        ...
        carousel_time = "2026-06-10T21:00:00+01:00"
            ...
            try:
                ...
                for p in instagram_posts_sorted:
                    ...
                    update_final_post_copy(
                        state.final_posts_path,
                        post_id=p.post_id,
                        notes="[2026-06-10] Agendado como parte do Carrossel Combinado de slides das 21:00."
                    )
                    scheduled_summary.append({
                        "post_id": p.post_id,
                        "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-10) ===")
