...
# Plano de agendamento cronológico para hoje (2 de Junho de 2026)
PLAN = [
    ("topic_f917c693560cc81134", "2026-06-02T09:00:00+01:00"),  # OpenAI Rosalind Biodefense
    ("topic_deb760708fa8dfb7d6", "2026-06-02T12:00:00+01:00"),  # Foxconn e Bull / Atos
    ("topic_15fa24ba54c6288dc7", "2026-06-02T16:00:00+01:00"),  # Google Cloud e NTT Data
    ("topic_3fb5a8b3efe2408277", "2026-06-02T21:00:00+01:00"),  # NVIDIA e Foxconn
]

def main() -> None:
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-02) ===")
    ...
    # Cronológica: Topic 1 (09:00), Topic 2 (12:00), Topic 3 (16:00), Topic 4 (21:00)
    ...
    carousel_time = "2026-06-02T21:00:00+01:00"
    
    # Vamos verificar se os posts de Instagram já estão marcados como scheduled
    # Se o primeiro já está scheduled, podemos evitar agendar de novo para não duplicar no Buffer.
    ...
    if first_inst.status == "scheduled" and first_inst.buffer_post_id and first_inst.buffer_post_id != "manual_buffer_media_required":
        ...
        for p in instagram_posts_sorted:
            ...
            update_final_post_copy(
                state.final_posts_path,
                post_id=p.post_id,
                notes="[2026-06-02] Agendado como parte do Carrossel Combinado de 4 slides das 21:00."
            )
            scheduled_summary.append({
                "post_id": p.post_id,
                "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-02) ===")
