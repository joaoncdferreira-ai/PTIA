...
# Plano de agendamento cronológico para amanhã (5 de Junho de 2026)
PLAN = [
    ("topic_6cbda8134b84b4a29e", "2026-06-05T09:00:00+01:00"),  # Bruxelas Redesenha a Soberania Tecnológica
    ("topic_6a0ea582c0e3825ed4", "2026-06-05T13:00:00+01:00"),  # Lisboa gala dos Health AI Innovation Awards
    ("topic_0bc5510af3b90a9217", "2026-06-05T16:00:00+01:00"),  # Canadá AI Strategy
    ("topic_59a3ffda3f2e96e403", "2026-06-05T21:00:00+01:00"),  # IBM e Google Cloud Partnership
]

def main() -> None:
    load_dotenv()
    print("=== INICIANDO AGENDAMENTO EDITORIAL PREMIUM (2026-06-05) ===")
    ...
    if instagram_posts_sorted:
        ...
        carousel_time = "2026-06-05T21:00:00+01:00"
        ...
        if first_inst.status == "scheduled" and first_inst.buffer_post_id and first_inst.buffer_post_id != "manual_buffer_media_required":
            ...
            for p in instagram_posts_sorted:
                ...
                update_final_post_copy(
                    state.final_posts_path,
                    post_id=p.post_id,
                    notes="[2026-06-05] Agendado como parte do Carrossel Combinado de slides das 21:00."
                )
                scheduled_summary.append({
                    "post_id": p.post_id,
                    "channel": "instagram",
    ...
    print("\n=== TABELA DE RESUMO DE AGENDAMENTO (2026-06-05) ===")
